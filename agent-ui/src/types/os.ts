...
export interface SessionEntry {
  ...
  created_at: number
  updated_at?: number
  // Enriched at fetch time from agent/team context
  agent_id?: string
  team_id?: string
}
...
// Session detail from GET /sessions/{session_id}/runs response
...
// Agent full config from GET /agents/{agent_id}
...
export interface AgentFullConfig {
  ...
  default_tools?: AgentDefaultToolsConfig
  system_message?: AgentSystemMessageConfig
}
